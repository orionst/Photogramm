...
public class PhotoListFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageView = layout.findViewById(R.id.test_picture);
        ...
        final PhotoListAdapter adapter = new PhotoListAdapter(layout.getContext(), photoList);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PHOTO && resultCode == Activity.RESULT_OK) {
            imageView.setImageURI(photoURI);    //тестовый вывод
            Snackbar.make(this.getView(), "Фото добавлено", Snackbar.LENGTH_LONG)
